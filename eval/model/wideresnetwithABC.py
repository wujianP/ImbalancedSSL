...
class WideResNet(nn.Module):
    def __init__(self,
        ...
        self.conv1 = nn.Conv2d(3,
                               ...
                               bias=False)
        # 1st block
        self.block1 = NetworkBlock(n, n_channels[0], n_channels[1], block, 1, drop_rate, activate_before_residual=True)
        # 2nd block
        ...
        self.fc_base = nn.Linear(n_channels[3], num_classes)
        self.n_channels = n_channels[3]
        self.fc_abc = nn.Linear(n_channels[3], num_classes)
