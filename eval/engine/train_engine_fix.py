...
class TrainEngine(object):
    def __init__(self, args, labeled_loader=None, unlabeled_loader=None, model=None, tcp_resume=False,
                 ...
                 sample_num_per_class=None, num_class=None, logger=None, log_writer=None):
        self.args = args
        ...
        self.tcp = TailClassPool(args=args, log_writer=log_writer, mode='U')
    ...
    def process_tcp(self, soft_pseudo, input_features, epoch):
        # 使用TCP
        ...
        if self.log_writer and (self.log_writer.step % self.args.writer_log_iter_freq == 0):
            self.tcp.log_inpool_stat(num_class=self.num_class)
