...
OUT='/share/home/wjpeng/ckp/experiments/bmb/ablate/memory-size-cifar100/s128g64_seed0'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29501 ABCfix.py \
 ...
 cd '/share/home/wjpeng/projects/ablateBMB'
DATA='/share_io03_ssd/ckpt2/wjpeng/dataset'
OUT='/share/home/wjpeng/ckp/experiments/bmb/ablate/memory-size-cifar100/s128g128_seed0'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29501 ABCfix.py \
 --gpu 1 \
 --tcp_pool_size 128 \
 --tcp_get_num 128 \
