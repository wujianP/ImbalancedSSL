...
DATA='/dev/shm'
OUT='/discobox/wjpeng/ckp/cifar10/r150/64-adaW+TCP/07-Tcp-s256g128-bp3-sp1.25-wt1.5-warm0.sh'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29557 ABCfix.py \
 --tcp_pool_size 256 \
 --tcp_get_num 128 \
