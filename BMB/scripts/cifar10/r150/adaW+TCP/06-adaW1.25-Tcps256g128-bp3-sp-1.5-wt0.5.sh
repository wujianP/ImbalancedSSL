...
OUT='/share/home/wjpeng/ckp/cifar10/r150/64-adaW+TCP/06-adaW1.25-Tcps256g128-bp3-sp-1.5-wt0.5.sh'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29548 ABCfix.py \
 --tcp_pool_size 256 \
 --tcp_get_num 128 \
