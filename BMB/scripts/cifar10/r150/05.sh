...
DATA='/dev/shm'
OUT='/discobox/wjpeng/ckp/cifar10/r150/05-adaW1-Tcp-s2048-g128-bp3-sp0.75-wt0.5.sh'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29515 ABCfix.py \
 --gpu 5 \
 --tcp_pool_size 256 \
 --tcp_get_num 128 \
