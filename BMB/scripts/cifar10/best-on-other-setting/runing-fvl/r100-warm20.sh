...
OUT='/share/home/wjpeng/ckp/experiments/TCP/cifar10/adaweight+TCP/r100-warm20'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29509 ABCfix.py \
 --gpu 0 \
 --tcp_pool_size 256 \
 --tcp_get_num 128 \
