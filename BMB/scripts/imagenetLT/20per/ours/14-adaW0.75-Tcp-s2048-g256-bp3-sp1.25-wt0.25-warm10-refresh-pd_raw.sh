...
OUT='/discobox/wjpeng/ckp/imagenetLT/semi20/ours/14-adaW0.75-Tcp-s2048-g256-bp3-sp1.25-wt0.25-warm10-refresh-pd_raw'
python -m torch.distributed.launch --nproc_per_node=8 --master_port 29501 ABCfix.py \
 --tcp_refresh_after_warm \
 --tcp_pool_size 2048 \
 --tcp_get_num 256 \
 --tcp_distribution_type pd_raw \
 --tcp_sync_input \
