...
def main():
    ...
    optimizer = optim.Adam(model_without_ddp.parameters(), lr=args.lr, weight_decay=args.wd)
    ema_optimizer = WeightEMA(model_without_ddp, ema_model, alpha=args.ema_decay) # Exponential Moving Avg
    start_epoch = 0
