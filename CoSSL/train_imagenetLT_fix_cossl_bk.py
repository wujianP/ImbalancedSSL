"""
This script should be used after the training of the bmb_train_imagenetLT_fix.py
"""
...
def main():
    ...
    for epoch in range(start_epoch+args.warm_tfe, args.epochs + start_epoch):
        ...
        *train_info, = train(labeled_trainloader, unlabeled_trainloader, model, ema_model, optimizer, ema_optimizer,
        ...
        # Evaluation part
        if args.disable_ema_model:
            test_loss, test_acc, *_ = validate_teacher(test_loader, model, teacher_head, criterion, use_cuda, mode='Test')
        else:
