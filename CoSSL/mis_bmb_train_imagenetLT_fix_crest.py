...
def get_split(x_train, y_train, x_unlab_test, y_unlab_test, class_im_ratio, num_classes, alpha=3,
...
def train(labeled_trainloader, unlabeled_trainloader, model, optimizer, scheduler, ema_optimizer, criterion, epoch,
          use_cuda,
...
def get_cosine_schedule_with_warmup(optimizer, num_warmup_steps, num_training_steps, num_cycles=7. / 16.,
                                    last_epoch=-1):
