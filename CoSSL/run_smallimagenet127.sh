...
python train_small_imagenet127_fix.py \
 --labeled_percent 0.1 \
 --img_size 32 \
 --epoch 500 \
 --val-iteration 500 \
 --out ./results/small_imagenet127_32x32/test \
 --gpu 0
...
#python small_imagenet127_fix.py \
#--labeled_percent 0.1 \
#--img_size 64 \
#--epoch 500 \
#--val-iteration 500 \
#--out ./results/small_imagenet127_64x64/fixmatch/baseline/resnet50_labeled_percent01 \
#--gpu 0
