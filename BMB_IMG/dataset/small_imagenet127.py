...
def get_small_imagenet(root, img_size, labeled_percent=0.1, seed=0):
    labeled_percent /= 100
    ...
    num_unlabeled_data_per_cls = num_data_per_cls
    ...
    print('train labeled index:', train_labeled_idxs[:100])
    ...
    sample_num_per_class = {
        ...
        'unlabeled': num_unlabeled_data_per_cls
    }

    print(f"#Labeled: {sum(num_labeled_data_per_cls)} #Unlabeled: {sum(num_unlabeled_data_per_cls)}")

    return train_labeled_dataset, train_unlabeled_dataset, test_dataset, sample_num_per_class
