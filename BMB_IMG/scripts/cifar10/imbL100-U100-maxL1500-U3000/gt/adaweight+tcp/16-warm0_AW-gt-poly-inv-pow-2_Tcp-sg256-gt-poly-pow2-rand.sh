...
DATA='/dev/shm'
OUT='/discobox/wjpeng/ckp/cifar10/imbL100-U100-maxL1500-U3000/adaweight+tcp/warm0_AW-gt-poly-inv-pow-2_Tcp-sg256-gt-poly-pow1.5-rand'
python -m torch.distributed.launch --nproc_per_node=2 --master_port 29506 ABCfix.py \
 --gpu 4,5 \
 --tcp_pool_size 256 \
 --tcp_get_num 256 \
