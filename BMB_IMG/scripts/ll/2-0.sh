...
OUT='/share/home/wjpeng/ckp/experiments/bmb/ablate/memory-size-cifar100/s128g16_seed0'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29500 ABCfix.py \
 ...
 cd '/share/home/wjpeng/projects/ablateBMB'
DATA='/share_io03_ssd/ckpt2/wjpeng/dataset'
OUT='/share/home/wjpeng/ckp/experiments/bmb/ablate/memory-size-cifar100/s128g32_seed0'
python -m torch.distributed.launch --nproc_per_node=1 --master_port 29500 ABCfix.py \
 --gpu 0 \
 --tcp_pool_size 128 \
 --tcp_get_num 32 \
