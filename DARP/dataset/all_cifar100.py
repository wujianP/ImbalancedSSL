...
transform_strong.transforms.insert(0, RandAugment(2, 14))
...
def get_cifar100(root, l_samples, u_samples, seed, transform_train=transform_train, transform_strong=transform_strong,
